...
function strEnc(data) {
    ...
    var firstKey="dqdz2FFx";
    var secondKey="adsj^59D";
    var thirdKey="!DJF)03l";
 ...
 */
function strDec(data) {
	var firstKey="dqdz2FFx";
    var secondKey="adsj^59D";
    var thirdKey="!DJF)03l";
	var leng = Base64.decode(data).length;
	var decStr = "";
	var firstKeyBt, secondKeyBt, thirdKeyBt, firstLength, secondLength, thirdLength;
	if (firstKey != null && firstKey != "") {
		firstKeyBt = getKeyBytes(firstKey);
	...
	var i = 0;
	for (i = 0; i < iterator; i++) {
		var tempData = Base64.decode(data).substring(i * 16 + 0, i * 16 + 16);
